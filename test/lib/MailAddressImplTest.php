 ...
 * Time: 6:08 PM
 */
use ChristianBudde\PartMail\model\Address;
use ChristianBudde\PartMail\model\AddressImpl;
use ChristianBudde\PartMail\model\AddressLibrary;
use ChristianBudde\PartMail\model\DomainLibraryImpl;
...
class MailAddressImplTest extends CustomDatabaseTestCase{
    ...
    public function testGetMailBoxReturnsRightInstance(){
        ...
        $this->assertInstanceOf('ChristianBudde\PartMail\model\MailboxImpl', $mb1);
        $this->assertNull($mb2);
